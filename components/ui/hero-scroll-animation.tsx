  ...
  return (
    <div className="sticky top-0 h-[100svh] w-full">
      ...
      >
        ...
        <article className="relative z-10 mx-auto flex h-full w-full items-start justify-center px-6 pb-6 pt-12 min-[430px]:items-center min-[430px]:py-10 md:items-center md:px-10 md:py-12">
          <motion.div
            style={{ opacity: layoutOpacity, y: layoutY }}
            className="w-full max-w-6xl px-0 py-0 min-[430px]:py-6 sm:px-4 sm:py-6 lg:px-8 lg:py-8"
          >
            <div className="grid items-start gap-4 pt-3 min-[430px]:pt-0 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14 lg:pt-0">
              <motion.figure
                style={{ opacity: imageOpacity, y: imageY }}
                className="mx-auto mt-1 w-full max-w-[220px] rounded-[3px] border border-[#44624a]/10 bg-white p-2 shadow-[0_18px_50px_rgba(68,98,74,0.12)] min-[430px]:max-w-[260px] min-[430px]:mt-2 sm:mt-3 sm:max-w-[360px] sm:p-4 lg:mt-0 lg:max-w-[380px]"
              >
              ...
              <div className="flex flex-col justify-start">
                <motion.h2
                  ...
                  className="font-sans text-center text-[1.8rem] normal-case leading-[1.02] tracking-[-0.05em] text-[#44624a] min-[430px]:text-[2.05rem] sm:text-[3.4rem] lg:text-right lg:text-[4.7rem]"
                >
                ...
                <motion.div
                  ...
                  className="mt-3 max-w-xl text-left min-[430px]:mt-7 lg:mt-12"
                >
                  <p
                    style={{ textTransform: 'none', fontVariantCaps: 'normal' }}
                    className="font-sans text-[0.9rem] normal-case leading-[1.65] text-[#44624a]/88 min-[430px]:text-[0.98rem] sm:text-[1.45rem]"
                  >
                ...
                <motion.div
                  ...
                  className="mt-4 max-w-md pb-3 text-left min-[430px]:mt-8 lg:mt-12"
                >
                  <p
                  ...
                  <p
                    ...
                    className="mt-2 text-[1.7rem] leading-[1.02] text-[#6b8a68] min-[430px]:mt-4 sm:mt-4 sm:text-[3.25rem]"
                  >
                    Joshua and Vien
                  </p>
                </motion.div>
